...
> **Многоагентная ИИ-система полного цикла для производства контента, видеомонтажа, конкурентного шпионажа и веб-автоматизации** — от расшифровки созвонов и базы знаний FTS5 до готовых постов в 5 стилях, 9:16 видеомонтажа с субтитрами, генерации каруселей 1080×1350, Playwright-автоматизации и PR-аутрича.
